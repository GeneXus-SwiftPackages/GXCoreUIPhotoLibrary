...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-2.0.0-beta.22.xcframework.zip",
			checksum: "0e03f7b922a34191e231b9df126e847f80eb1c2d1b051f81875cbea198b0e8e6"
		)
	]
)