...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-2.0.0-beta.6.xcframework.zip",
			checksum: "2a2c19ebbe46e733a8cfa1cf2f90f5c614f02f1117567ba2680085eeb4a9836d"
		)
	]
)