...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.1.0-beta.5.xcframework.zip",
			checksum: "6f752bcb828e20c6c52c4d291b214052c18d7f00dee194b52a18de0afd543ea8"
		)
	]
)