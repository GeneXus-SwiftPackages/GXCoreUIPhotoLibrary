...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreUIPhotoLibrary-4.2.0-rc.34.xcframework.zip",
			checksum: "0e8a0a9ebe7bb722fd2b742297e35db836e329f50d36ddae74412571f08c08db"
		)
	]
)