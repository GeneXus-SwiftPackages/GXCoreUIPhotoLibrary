...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreUIPhotoLibrary-1.5.16.xcframework.zip",
			checksum: "7ceaa02c70d4be1d406768c173a28ebce2c559af2f2efa1ed20515abe5c10c82"
		)
	]
)