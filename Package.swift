...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-2.0.0-beta.34.xcframework.zip",
			checksum: "45dfed8c8f52f0c3039c5adafec7c775c4665dd6be73d243eda78a2168c6369f"
		)
	]
)