...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.2.0-beta.22.xcframework.zip",
			checksum: "126ef8b583260b54a7d1b4fb6642a2e454e83577d3398be484677e8d40785354"
		)
	]
)