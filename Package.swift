...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.0.0-beta.14.xcframework.zip",
			checksum: "efce9e25ce92a42f55b3a440e4a7df7cc74560728ed8b42016834770a23e8fb0"
		)
	]
)