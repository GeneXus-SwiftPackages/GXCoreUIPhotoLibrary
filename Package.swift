...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreUIPhotoLibrary-3.2.0.xcframework.zip",
			checksum: "6d03acaaa11a9abd12e628e84586e5fdffa5accf5646db0011417910b44a8809"
		)
	]
)