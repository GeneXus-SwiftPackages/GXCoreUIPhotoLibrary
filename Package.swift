...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-4.1.0-beta.23.xcframework.zip",
			checksum: "e78ed78db59af178f8bfda57e6f1c2fe3407fdb4be8f3879e4033627c159799c"
		)
	]
)