...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.1.0-beta.27.xcframework.zip",
			checksum: "642700854947694a1bbd3e3e1c014d9f724202afa75732711ebaecf412a5e3d2"
		)
	]
)