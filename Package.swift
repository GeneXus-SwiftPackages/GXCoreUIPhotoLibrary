...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreUIPhotoLibrary-1.3.6.xcframework.zip",
			checksum: "a899184693a2cad8617c910be38a508f24b3cd55e62eb12b7befe93cd4051d3f"
		)
	]
)