...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.2.0-beta.23.xcframework.zip",
			checksum: "b475e00dc8d40e0a456b5f311a856d1d412f091e05d7498aeb2a7001ced402a1"
		)
	]
)