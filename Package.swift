...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.4.0-beta.19.xcframework.zip",
			checksum: "57e0b65443183a46682d7cffc6ba1ba46bd3d3d8932dc4bf3a6c1491c17372c4"
		)
	]
)