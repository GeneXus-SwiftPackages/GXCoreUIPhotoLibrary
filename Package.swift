...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.0.0-beta.20230623154354.xcframework.zip",
			checksum: "f933398d70a029d0221436a0f3ff020c716c5f887a1814f15b647dff6f6fbdbe"
		)
	]
)