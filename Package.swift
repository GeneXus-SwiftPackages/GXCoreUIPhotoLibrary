...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.1.0-beta.11.xcframework.zip",
			checksum: "023dfbf7151ce562c609f4a6e03e114a9ffe650e4c942b826cf2600b59e11d99"
		)
	]
)