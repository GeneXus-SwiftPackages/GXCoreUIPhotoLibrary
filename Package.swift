...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreUIPhotoLibrary-1.5.0-rc.2.xcframework.zip",
			checksum: "265c3b8646d4749a90ff42f6a73d302dc49864d5a4a7f7de137f1e1c3f7bb074"
		)
	]
)