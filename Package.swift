...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreUIPhotoLibrary-3.1.0.xcframework.zip",
			checksum: "d19b53251ca00dbed623c69681b0e96b548f3a47b0f5aaee138c2845cf539aed"
		)
	]
)