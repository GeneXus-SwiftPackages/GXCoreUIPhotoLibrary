...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-4.2.0-beta.12.xcframework.zip",
			checksum: "d980dca78f0007f995e23e5cdbb52a4db053cb519a419d18593fd0db85080234"
		)
	]
)