...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreUIPhotoLibrary-1.4.27.xcframework.zip",
			checksum: "a41d56d029f20e6a326e63f1fd25f613a5b1a650de19ef37aa8ceb33220069e7"
		)
	]
)