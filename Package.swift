...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.2.0-beta.35.xcframework.zip",
			checksum: "54b60ddcf161c2d1e3bc9c2f94d42a45d14dbfadd431cc57ee6cb49046b77dd9"
		)
	]
)