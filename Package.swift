...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreUIPhotoLibrary-3.0.2.xcframework.zip",
			checksum: "440fd8248e3c35ab9a9905203d866a04e419b77a225369fb28a3c410151ae816"
		)
	]
)