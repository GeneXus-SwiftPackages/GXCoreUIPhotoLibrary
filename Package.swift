...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-4.1.0-beta.9.xcframework.zip",
			checksum: "6df19863c1ff79d3fa447f21734878d7004ac0b4935737275bac805df82ed2c3"
		)
	]
)