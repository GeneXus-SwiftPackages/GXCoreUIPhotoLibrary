...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.1.0-beta.794.xcframework.zip",
			checksum: "8f6bda75529faefd4dc007ebf8f0feb2b6b75a7ac55e2d8f40bf5892ad673263"
		)
	]
)