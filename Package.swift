...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-2.2.0-beta.17.xcframework.zip",
			checksum: "c502a7431640b3cd3ea69dd36066a779e7b08d9521d45e456420d37258470b02"
		)
	]
)