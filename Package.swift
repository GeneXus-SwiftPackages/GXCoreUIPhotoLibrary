...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreUIPhotoLibrary-5.0.0-rc.1.xcframework.zip",
			checksum: "a2382d6e59b4c2916e24756cdfd01ddb9faaef04aead7130f85c8eb333bd0857"
		)
	]
)