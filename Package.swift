...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-2.2.0-beta.14.xcframework.zip",
			checksum: "a2d3422af8fc4efd0c32619de9227e582987df0a224915d431acebf183b54a24"
		)
	]
)