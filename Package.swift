...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.3.0-beta.1.xcframework.zip",
			checksum: "77d86e6498ab4fa7a9dbd02aff6d2acdd79ac6d7ac87ce0899d74d077f293246"
		)
	]
)