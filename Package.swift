...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.6.0-beta.4.xcframework.zip",
			checksum: "74946f5305d9a1bc3ed2173da7f7a87184967943a866b0eb79a3a55c45225b95"
		)
	]
)