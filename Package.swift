...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.1.0-beta.795.xcframework.zip",
			checksum: "3ae35fa2e889bd7ad23976404f4466542872d6374932726c3713d8470cdbfc70"
		)
	]
)