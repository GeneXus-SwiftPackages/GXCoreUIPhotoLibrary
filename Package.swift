...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreUIPhotoLibrary-4.1.0-rc.14.xcframework.zip",
			checksum: "f206b8358adb90efc17ffaaed1ed2bf498da099fd8c9f941327b9ab02bfbb479"
		)
	]
)