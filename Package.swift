...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreUIPhotoLibrary-4.1.2.xcframework.zip",
			checksum: "98e0382701be20d55aa4d373a0a5d446926135aaaaf7d06430c24a60e61b6412"
		)
	]
)