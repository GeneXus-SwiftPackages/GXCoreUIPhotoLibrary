...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreUIPhotoLibrary-1.1.0-rc.3.xcframework.zip",
			checksum: "5e126d32acebcbdb6bfa4fd7d9f32541b892b1da8b432d7385480c1890c046d9"
		)
	]
)