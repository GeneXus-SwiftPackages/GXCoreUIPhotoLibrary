...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreUIPhotoLibrary-4.0.4.xcframework.zip",
			checksum: "0b5222fe395d70b52e9c48dcd80a2f4488ffd9cc50d83ba6962d7daad119db04"
		)
	]
)