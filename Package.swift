...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-2.0.0-beta.27.xcframework.zip",
			checksum: "a64176594890203a20554a0b925dcd1472d5975dc5574c8e0949f8edcb1cfaf8"
		)
	]
)