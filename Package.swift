...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.4.0-beta.2.xcframework.zip",
			checksum: "9b2d582fb8db60fa5b7c2bb462283e1c26a87135259b2ebe3c67adc89086ac80"
		)
	]
)