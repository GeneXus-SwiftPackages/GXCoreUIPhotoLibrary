...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreUIPhotoLibrary-1.4.0-rc.5.xcframework.zip",
			checksum: "56df86ac5fb9b397e3057660fd2cf8bb3a57745c986b9c7ebdbb9226d1e05948"
		)
	]
)