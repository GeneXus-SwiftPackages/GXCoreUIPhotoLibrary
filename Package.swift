...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.2.0-beta.10.xcframework.zip",
			checksum: "8dbde23401652250361a1ecec345be675f60ae7883a1683361bac6e036c24027"
		)
	]
)