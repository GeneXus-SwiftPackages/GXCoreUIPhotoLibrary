...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-4.2.0-beta.14.xcframework.zip",
			checksum: "daf6e0ce7278b46f90c11087e88b0b71d18f516162d3ef8c998f869caa65bb54"
		)
	]
)