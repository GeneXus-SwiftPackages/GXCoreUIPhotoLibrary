...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.1.0-beta.3.xcframework.zip",
			checksum: "1defe3ebcfdcb0b4844dc97751f37fcf16cfd6890dbef708b8d00dbf5e340f72"
		)
	]
)