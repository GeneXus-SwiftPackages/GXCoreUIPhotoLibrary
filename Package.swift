...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.0.0-beta.15.xcframework.zip",
			checksum: "7041437ebcc03f993cdcc36c577acbf993217851fa1b0eaf0ff9dc4b71e58918"
		)
	]
)