...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-2.0.0-beta.35.xcframework.zip",
			checksum: "f209ab454019d49079b54c227d171bc880a3c32ab7dac4cb2535ae040d031321"
		)
	]
)