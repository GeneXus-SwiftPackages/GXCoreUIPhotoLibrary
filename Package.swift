...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.5.0-beta.8.xcframework.zip",
			checksum: "04818a4abcd0ba8a6e9122fcf730aae837b9bdfbf10fb460d76bb809352309af"
		)
	]
)