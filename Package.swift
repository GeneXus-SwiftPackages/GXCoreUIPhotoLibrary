...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-4.1.0-beta.12.xcframework.zip",
			checksum: "35d235d5caa36489c300db22b6352a15d234e769c055cce033d9a35af6bc2bd2"
		)
	]
)