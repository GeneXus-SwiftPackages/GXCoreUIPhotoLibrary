...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.2.0-beta.6.xcframework.zip",
			checksum: "a537254e55090d5b22d38bdf71d43a63e3388c716a20b66baa46e6921d189724"
		)
	]
)