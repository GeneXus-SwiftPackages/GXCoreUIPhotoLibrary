...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.2.0-beta.17.xcframework.zip",
			checksum: "901beb8706b89f64f1c95209a178685eb594c9418e9509fee86ede8ed8c486ba"
		)
	]
)