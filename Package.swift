...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.2.0-beta.14.xcframework.zip",
			checksum: "adf4b979acae24f21edc70d124d831ceac857cfe9697787e50d73a98e7048f6a"
		)
	]
)