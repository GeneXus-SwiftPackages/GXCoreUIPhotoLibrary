...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-2.2.0-beta.13.xcframework.zip",
			checksum: "541590591e215ba3008e6f13db9eff08d6c3f7bdb56f66a23ff463f4d0a02406"
		)
	]
)