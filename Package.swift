...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.0.0-beta.20230721115743.xcframework.zip",
			checksum: "78dadea3b931b04767864997dd71c1f87b33aa8b4da2a1bb5d39f2f2d11ca3a8"
		)
	]
)