...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.0.0-beta.17.xcframework.zip",
			checksum: "f50dc9a8b7a322fe95a24e125574ab43b6472adb65eb6cd188011c217e55fa2f"
		)
	]
)