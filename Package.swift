...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.1.0-beta.12.xcframework.zip",
			checksum: "4102f3800fcfe0fd06b5b6e67fc97fc3a357cf5c10df9e38bef50149046669b0"
		)
	]
)