...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.2.0-beta.19.xcframework.zip",
			checksum: "f39a793f9628cfb930372118ed57f7b2ade635d2d5a0854ae4fbfc72ced6c539"
		)
	]
)