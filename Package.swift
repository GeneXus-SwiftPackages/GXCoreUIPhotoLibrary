...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.4.0-beta.18.xcframework.zip",
			checksum: "a31212998516cc1574f8b928bb9e4403d4e8b2cccc759af75ad38a9455abb2f4"
		)
	]
)