...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreUIPhotoLibrary-4.1.0-rc.22.xcframework.zip",
			checksum: "1fa039d94e7501f554546339dc0b892645f568dbb222ef91104243bfef903d78"
		)
	]
)