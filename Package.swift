...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.5.0-beta.16.xcframework.zip",
			checksum: "dbdab0f6cbc8394267c80a2e8febcaa81f536a1abcc9e24032355cc697e659f7"
		)
	]
)