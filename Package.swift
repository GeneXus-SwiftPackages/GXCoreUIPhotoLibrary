...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-2.1.0-beta.26.xcframework.zip",
			checksum: "14d5b9920c22431d0b2b1fbbe411739274c461fdb59ffecd41e08e0202741df2"
		)
	]
)