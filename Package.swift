...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreUIPhotoLibrary-1.1.0-rc.4.xcframework.zip",
			checksum: "a05398d36724dcb116b6b3510365d529023b24abfc2ad353db890c09e8b21764"
		)
	]
)