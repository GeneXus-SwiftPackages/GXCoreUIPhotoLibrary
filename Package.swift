...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.1.0-beta.13.xcframework.zip",
			checksum: "11b2709609773b50e0d13900bd5722d6c700020d469ec1a810f8b8454653886a"
		)
	]
)