...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreUIPhotoLibrary-1.2.1.xcframework.zip",
			checksum: "26ce019422dd8939995e887eb57cd3658219af89c5915b5047018374a3257016"
		)
	]
)