...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.3.0-beta.10.xcframework.zip",
			checksum: "23697280d7bf8176029a1ae06e3bf2c9154e1c2f3384092f1a04221ac560a6e7"
		)
	]
)