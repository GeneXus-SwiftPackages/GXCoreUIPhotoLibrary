...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.5.0-beta.17.xcframework.zip",
			checksum: "100f98e19e03943cfb881a6e71dcd99dfb45166b666a8b26b6bc6a215a84731c"
		)
	]
)