...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.4.0-beta.7.xcframework.zip",
			checksum: "3fa3c9e80776ead8483852958cf45965ef411505cf2ef9a745416c6237ec2a16"
		)
	]
)