...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-4.2.0-beta.18.xcframework.zip",
			checksum: "1451ed333804a7576bd3315b2fa192d13a3d10474c0fc8b69c82ecb8e34f17b6"
		)
	]
)