...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-4.2.0-beta.7.xcframework.zip",
			checksum: "3ab91ec9f79592f6357de15b190126058b23def5c58b32a002f2b3bcfa79ca55"
		)
	]
)