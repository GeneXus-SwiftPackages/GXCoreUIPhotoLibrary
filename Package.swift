...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-4.0.0-beta.48.xcframework.zip",
			checksum: "ee5508c508980de3ff4bbd5e3078ac0a574bf0c3dab8c9271ac81ee80cd3c16f"
		)
	]
)