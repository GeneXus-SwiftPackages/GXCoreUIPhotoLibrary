...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.1.0-beta.17.xcframework.zip",
			checksum: "a707a0244f20af6d2de7358beb7031248997dca313bf7e6f38ce91235dc3c51a"
		)
	]
)