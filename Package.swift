...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-2.0.0-beta.32.xcframework.zip",
			checksum: "db69ae0b0726ff7eef68a1ef5593d38951db955eb50bb295689d3a2643a77e29"
		)
	]
)