...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreUIPhotoLibrary-1.4.0-rc.21.xcframework.zip",
			checksum: "d9fd1dc027a9e6d9bd6b779132adf5a9203b8b34c97fad4f520013feb2499e80"
		)
	]
)