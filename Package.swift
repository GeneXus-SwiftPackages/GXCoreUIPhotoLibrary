...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.4.0-beta.11.xcframework.zip",
			checksum: "cd18ee4aca9c612fea4f1f2bdf03fe0141c8acd8469d63c6ce0d8926c0d474d4"
		)
	]
)