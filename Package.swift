...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.6.0-beta.3.xcframework.zip",
			checksum: "e1fa7ea9e3f052eb037194bf04a1b934c2e0096588819d99938b0dd1610968ac"
		)
	]
)