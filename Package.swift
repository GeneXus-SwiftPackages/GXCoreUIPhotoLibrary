...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreUIPhotoLibrary-1.2.0-rc.15.xcframework.zip",
			checksum: "6e9dafa503bcc5b624fc65e718854c108bfdcf547940d84386fe1b303b6606f6"
		)
	]
)