...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-4.1.0-beta.2.xcframework.zip",
			checksum: "afc9ea61824f7758c09a1060ef1ef4227485580194daa4570c65ae8ce72f4931"
		)
	]
)