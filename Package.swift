...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreUIPhotoLibrary-3.0.3.xcframework.zip",
			checksum: "7bbaffc40ccb4a482c853c1281f983144b5553bc48e74d1dfd3e15202da1eb7e"
		)
	]
)