...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-4.1.0-beta.8.xcframework.zip",
			checksum: "05b63dc83ef84e9b64d05124b8317589904836ee238035761b77d6a1d5058d03"
		)
	]
)