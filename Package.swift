...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-2.0.0-beta.36.xcframework.zip",
			checksum: "f33963ee0124fcbfb502edb3b47a484f79424eb846a8aacbd5f0a97414f5e5ed"
		)
	]
)