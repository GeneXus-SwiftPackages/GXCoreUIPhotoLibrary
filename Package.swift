...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.2.0-beta.21.xcframework.zip",
			checksum: "71b7b16c5624baf275ed577da59360eb41f9072753e0679b81c40eeba4570054"
		)
	]
)