...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.5.0-beta.28.xcframework.zip",
			checksum: "8a5d1b376021d47a2b50d77674495bae9a41622a218a2b28f8adcbafd99e6716"
		)
	]
)