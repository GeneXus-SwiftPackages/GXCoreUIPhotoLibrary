...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.2.0-beta.25.xcframework.zip",
			checksum: "0981a00a87ecb49306b4d5a0125e625946012563de14eca8d99861fd209b23ce"
		)
	]
)