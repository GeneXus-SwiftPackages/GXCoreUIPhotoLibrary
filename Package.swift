...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.2.0-beta.27.xcframework.zip",
			checksum: "f824bd928f06183e2107b2442ab597d01d489a4f7b21e8503cf82a749d4f2261"
		)
	]
)