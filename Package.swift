...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.0.0-beta.10.xcframework.zip",
			checksum: "dc5db1468c3b6a746880f8fd0f4975ad9f45d31e415a065f6eed93ae22a5e6af"
		)
	]
)