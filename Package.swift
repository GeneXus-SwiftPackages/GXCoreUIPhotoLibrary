...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreUIPhotoLibrary-3.1.0-rc.3.xcframework.zip",
			checksum: "0c5e1c55a8fa67dbfa9881c9924923a96c3569b29c78c5b0e27b5c83d713995b"
		)
	]
)