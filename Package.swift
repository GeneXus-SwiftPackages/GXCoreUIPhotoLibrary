...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreUIPhotoLibrary-3.2.0-rc.11.xcframework.zip",
			checksum: "6a2e0c8bc6f9d2434cf6a601610764286c0aee2e0cec0d93e71760e85b2c45b2"
		)
	]
)