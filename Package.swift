...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-2.0.0-beta.16.xcframework.zip",
			checksum: "f40b2a6c8c1136d1f6b30f190e71e2e70eeac750e7f6dc0049c91b20f1537a83"
		)
	]
)