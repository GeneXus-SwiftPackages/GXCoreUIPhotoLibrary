...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.2.0-beta.9.xcframework.zip",
			checksum: "fc021f61492ec63572a8061daaee752b1f15c25caf252973f66f25bcffca056a"
		)
	]
)