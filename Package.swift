...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.4.0-beta.8.xcframework.zip",
			checksum: "942e6c2079e890805659c267e01fde894865f873eadce921c98fc17a2e07573f"
		)
	]
)