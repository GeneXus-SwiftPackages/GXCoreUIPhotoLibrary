...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.1.0-beta.6.xcframework.zip",
			checksum: "db5ae72754a90bcb11e684b1151c615c3b97df3eeed068c563f9d2fb3cffc47a"
		)
	]
)