...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.1.0-beta.4.xcframework.zip",
			checksum: "c77fc1c17935bb64cc3a2a41b1713d03b28e871c47f1d8c27a5d45d88f4a8208"
		)
	]
)