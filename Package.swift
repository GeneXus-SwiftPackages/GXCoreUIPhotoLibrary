...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.2.0-beta.9.xcframework.zip",
			checksum: "6a89c051c620e22ec9e78a4b2a736f13c4e415342815df13a3c56ed533bcc3e8"
		)
	]
)