...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.2.0-beta.21.xcframework.zip",
			checksum: "0e6dd3c71d64748a695930c02dd8f305309433a48360dc5f0ad6804c38c49b29"
		)
	]
)