...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.3.0-beta.8.xcframework.zip",
			checksum: "009be1fbe552f57a3e3350270a93c76cad1c6cbf9ed659b479e8c788fdfd8357"
		)
	]
)