...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.2.0-beta.29.xcframework.zip",
			checksum: "a56db7aa3ee95fdfa343182efd3b56c1940cb532ab50ad6a6fd374a1f9a956b1"
		)
	]
)