...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-4.1.0-beta.7.xcframework.zip",
			checksum: "877c7080f6502370ad6f017503b8828dadd41dad346bfef3a161321abc24b88f"
		)
	]
)