...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.1.0-beta.32.xcframework.zip",
			checksum: "a55d2ab6f39f836826164ab98c9650f3ca5288cfc98165e6f823c8e8e7bf2cd5"
		)
	]
)