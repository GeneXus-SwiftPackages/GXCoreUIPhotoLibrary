...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreUIPhotoLibrary-2.0.0-rc.34.xcframework.zip",
			checksum: "3952de41eff89d47a038cf407f595a6074e87208f6720dd258345154c434d891"
		)
	]
)