...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-4.0.0-beta.0.xcframework.zip",
			checksum: "02241d944a7eb7530f1f56f0b74fa4907a67e76691ba8adfcdbf33efdfb0f6bc"
		)
	]
)