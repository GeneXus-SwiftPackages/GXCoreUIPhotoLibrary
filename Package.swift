...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.2.0-beta.28.xcframework.zip",
			checksum: "75c65965c44ff2b0b37c644c971200182c99b22a53622afdb9dc3d5cab00fc7b"
		)
	]
)