...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-4.2.0-beta.33.xcframework.zip",
			checksum: "ac45e63c27793ccee8d5e58eb55078c0d4f634c9b3cbc275238f1f412cb42977"
		)
	]
)