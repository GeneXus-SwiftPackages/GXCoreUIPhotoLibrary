...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.1.0-beta.10.xcframework.zip",
			checksum: "ef4338eaec0f4bf8fabf0349f1bf5aa303a9ece12c098bd1834c0e2399cd19c5"
		)
	]
)