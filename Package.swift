...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreUIPhotoLibrary-1.2.2.xcframework.zip",
			checksum: "f3e08f260aa039599f096c3b2a1f9c644e286b53266d2a523e348cec5b4d6951"
		)
	]
)