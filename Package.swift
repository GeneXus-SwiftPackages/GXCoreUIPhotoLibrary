...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.5.0-beta.9.xcframework.zip",
			checksum: "069fd0bba0b7283faf54401c399fb399094c3cc825212974294a52f886d3d40b"
		)
	]
)