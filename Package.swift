...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreUIPhotoLibrary-1.2.0-rc.1.xcframework.zip",
			checksum: "aef979d586ee49ed7f03287b6926c65764612a31d78c31829f5b9d918c6af886"
		)
	]
)