...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreUIPhotoLibrary-2.0.12.xcframework.zip",
			checksum: "89dd1ad0d47ee6a54cce214295a8cb753e957cc203118160dbe5f15493abd4bd"
		)
	]
)