...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.5.0-beta.19.xcframework.zip",
			checksum: "d78a234284bd762c084571650337ac30f763034a636b65e24eb26b9d762bb5e3"
		)
	]
)