...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-2.0.0-beta.26.xcframework.zip",
			checksum: "cac8543c8b8b8bc799eda356e242606076fd6088cd4ab03985ae29b5d8f4d564"
		)
	]
)