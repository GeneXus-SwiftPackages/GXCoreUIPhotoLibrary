...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-4.2.0-beta.24.xcframework.zip",
			checksum: "2c43b2a97c35293f953b7733e7003269a6172ff3b6d6de16b130f825081e0293"
		)
	]
)