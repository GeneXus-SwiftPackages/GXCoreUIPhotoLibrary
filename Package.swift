...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreUIPhotoLibrary-3.2.0-rc.0.xcframework.zip",
			checksum: "1e5b13f357313768783b6a70e2c1e2a6e2972620a09e3432dacdd848e40868e3"
		)
	]
)