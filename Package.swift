...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.6.0-beta.2.xcframework.zip",
			checksum: "53b29f9aa47475dc97719af4bc44859072ed7a27be244fc182bf705ccf89c7ec"
		)
	]
)