...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-4.2.0-beta.19.xcframework.zip",
			checksum: "309d46c40c62b8f75ee11923805f9ae80e3e5f4e0bb6c817752dc0b042604f2c"
		)
	]
)