...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.2.0-beta.41.xcframework.zip",
			checksum: "bc9ebf76fd4d4e23146e6204c792f3f7e13b6567c6567277b7260c8136889dee"
		)
	]
)