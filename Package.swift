...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-4.2.0-beta.31.xcframework.zip",
			checksum: "2a3e4d3feb7902680fe9a83bd48197af5a26c4c3f06d31dc503b3a2bff864e47"
		)
	]
)