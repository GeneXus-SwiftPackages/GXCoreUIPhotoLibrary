...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.5.0-beta.24.xcframework.zip",
			checksum: "5398197cde57844f4b1130a0c3325c63914d5652fe7ab072e232133e5f190503"
		)
	]
)