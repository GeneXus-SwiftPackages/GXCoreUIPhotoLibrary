...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreUIPhotoLibrary-1.1.0-rc.5.xcframework.zip",
			checksum: "16540d4c3538d13c9b90f235afaac82a173def3ca3e0ecaeaa6dbae771a7b2a8"
		)
	]
)