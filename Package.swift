...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreUIPhotoLibrary-3.1.0-rc.8.xcframework.zip",
			checksum: "21b3153ae7dbbf2017967da0cc1616dc1e1a33c13d32005dc743f21709666b61"
		)
	]
)