...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.1.0-beta.19.xcframework.zip",
			checksum: "a3716fc2d4eb5d3cec2932120710269410f2a1b117afff7f781e3a7ab3342cf4"
		)
	]
)