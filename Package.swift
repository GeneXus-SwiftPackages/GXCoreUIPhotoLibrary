...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.0.0-beta.20230710193719.xcframework.zip",
			checksum: "64df1d4cff19b1a2361f718983a4fcccf4badb59732b362bb74a6a011f4a5b5f"
		)
	]
)