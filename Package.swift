...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-4.1.0-beta.18.xcframework.zip",
			checksum: "bba5aba98f571aba18c29bc3b551b114cf279e862d18373a469816b4af66be2c"
		)
	]
)