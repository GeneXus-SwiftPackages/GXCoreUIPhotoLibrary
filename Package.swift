...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-4.1.0-beta.25.xcframework.zip",
			checksum: "274597f178036d683936907a5dafdc61e7bcf3bf911c3f53c4c4d282b38e5bca"
		)
	]
)