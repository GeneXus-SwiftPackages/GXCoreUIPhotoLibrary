...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-4.2.0-beta.23.xcframework.zip",
			checksum: "54235f8fe63534721e0f827110dde7daa183ce4c21c50013a268ef798c7bb1d0"
		)
	]
)