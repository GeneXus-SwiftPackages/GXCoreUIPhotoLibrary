...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.2.0-beta.33.xcframework.zip",
			checksum: "aee7b008cdc211f973df668480fb2341998a992e15d75f5603fc7586fe62265a"
		)
	]
)