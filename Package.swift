...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreUIPhotoLibrary-4.0.0.xcframework.zip",
			checksum: "9945c8797ba37c2ca9f1c87a37b34e98a3c197862b47f0027b9809c080899b8b"
		)
	]
)