...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreUIPhotoLibrary-2.2.0-rc.3.xcframework.zip",
			checksum: "a872f433058072beca498d4b475295eefc0132663150c6c9b2924c2f277eebaf"
		)
	]
)