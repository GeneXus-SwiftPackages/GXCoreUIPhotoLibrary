...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-4.2.0-beta.3.xcframework.zip",
			checksum: "4ac1acf1fc5ecf6c4d391c19479b62c72820e6fa57693221921335806079fae3"
		)
	]
)