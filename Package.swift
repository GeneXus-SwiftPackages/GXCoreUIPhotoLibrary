...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.4.0-beta.13.xcframework.zip",
			checksum: "8ab5bcfc4871aaadf96de6ff42bea6396d44ba77b9956ed8c659db65df00b201"
		)
	]
)