...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreUIPhotoLibrary-1.2.0-rc.25.xcframework.zip",
			checksum: "3cee20a22f64eda28fe0a2089cd50bcbc2264d3101af675c9f9587add63fa42c"
		)
	]
)