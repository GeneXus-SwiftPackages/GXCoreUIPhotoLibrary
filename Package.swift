...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-4.1.0-beta.21.xcframework.zip",
			checksum: "90d6ec7bab929a6075a20d8ba81b00805a77f22ed99a772209d8a23589928a70"
		)
	]
)