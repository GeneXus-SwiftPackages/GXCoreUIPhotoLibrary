...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreUIPhotoLibrary-1.2.0-rc.29.xcframework.zip",
			checksum: "3423a9ba68609c3121c39a2a8dfbac3a14cbac7356d5d6e1ce9e91e11c643fb5"
		)
	]
)