...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.2.0-beta.10.xcframework.zip",
			checksum: "acf6dbff63435941a0c1cc7f3478ef554dec6e65a658d2b18d7c29fafdd5e168"
		)
	]
)