...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.1.0-beta.9.xcframework.zip",
			checksum: "5c4c7c959dfd76d993bf823c32e6355617b1c12437241cd3a21f79fb40f2e4eb"
		)
	]
)