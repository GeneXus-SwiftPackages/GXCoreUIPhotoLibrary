...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.2.0-beta.15.xcframework.zip",
			checksum: "fe450dae74b5626b860c5431b5624aacf274431bde30bc1e7a0297bc5c5941b4"
		)
	]
)