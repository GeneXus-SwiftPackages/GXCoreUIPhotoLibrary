...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreUIPhotoLibrary-1.1.3.xcframework.zip",
			checksum: "2b578c6c9bedabe51ce41c95fea771707d2a38389ceb791452d0ea6352ece061"
		)
	]
)