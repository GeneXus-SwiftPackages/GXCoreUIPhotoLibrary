...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreUIPhotoLibrary-1.3.5.xcframework.zip",
			checksum: "52a68ab80397621c015ad18f720a1cb80cea5710786b77d958b733c5839dc991"
		)
	]
)