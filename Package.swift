...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreUIPhotoLibrary-4.1.3.xcframework.zip",
			checksum: "8e8bf0ed31569eaa1735ef46a4d1e363c1cdfeba02d8cce0b69f2a15be5e07aa"
		)
	]
)