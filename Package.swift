...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreUIPhotoLibrary-1.1.2.xcframework.zip",
			checksum: "1df44be68809495c0bb373ca495a9489a862de90fe2a075b24a5cbe2a0dedfd2"
		)
	]
)