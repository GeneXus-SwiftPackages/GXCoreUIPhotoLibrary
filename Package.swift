...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.0.0-beta.12.xcframework.zip",
			checksum: "19fa577f8335b0dd30e1a77a0915451372b8035f98d0a06d21cc4f11abb6466d"
		)
	]
)