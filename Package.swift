...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.4.0-beta.16.xcframework.zip",
			checksum: "b476c3d361a74441aa0ddb376e4aa148c104614544a9624a918bf1206a2e3d0d"
		)
	]
)