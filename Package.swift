...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-2.0.0-beta.28.xcframework.zip",
			checksum: "8e69bae28d9859ce513e84d9673a9369fcef8bb0c1b91677569c144fb73c4ff5"
		)
	]
)