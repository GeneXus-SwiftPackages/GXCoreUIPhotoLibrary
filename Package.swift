...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.2.0-beta.37.xcframework.zip",
			checksum: "a5e377b6a46d1f94f06d79754d165d593128b3dd825cecbcd3d8dc2356b23852"
		)
	]
)