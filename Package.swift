...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreUIPhotoLibrary-3.2.0-rc.12.xcframework.zip",
			checksum: "8132f17e7578a1d114c61c76a4a37bc539f57e6bf734e5c02ac596b99c129f85"
		)
	]
)