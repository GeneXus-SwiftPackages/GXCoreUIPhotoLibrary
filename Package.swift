...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.2.0-beta.34.xcframework.zip",
			checksum: "00d8d44809beee9a59c7dc6d49672b359ad8ff8e4ee15c239b6f5fe8a2b055b7"
		)
	]
)