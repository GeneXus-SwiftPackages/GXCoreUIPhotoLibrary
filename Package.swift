...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.2.0-beta.22.xcframework.zip",
			checksum: "3f49c42f6a4dd56516a8ba7373b9256f6277f5420129dcdcabffb8946ced0191"
		)
	]
)