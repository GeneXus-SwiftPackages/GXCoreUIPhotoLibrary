...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.4.0-beta.20.xcframework.zip",
			checksum: "f12f35cb03527d5ede7de886ddfeb6ea59e9dc9e86acc982c6040a6610f7a32e"
		)
	]
)