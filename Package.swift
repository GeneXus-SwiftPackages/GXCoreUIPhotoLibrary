...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-2.0.0-beta.23.xcframework.zip",
			checksum: "8d403bf2201265a474e578314eadb6b93da157ec2ba0a50067fe084b0955b4f5"
		)
	]
)