...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.2.0-beta.17.xcframework.zip",
			checksum: "f4156b9ad2091c806a8bed536efe091ef580f8edb09bdee12ea71097699585b2"
		)
	]
)