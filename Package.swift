...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreUIPhotoLibrary-3.0.1.xcframework.zip",
			checksum: "8037453983a76a4c8713e770ec89a689b7b9ee7b7e0967cd49efbccc1407898a"
		)
	]
)