...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.5.0-beta.13.xcframework.zip",
			checksum: "ddb93bd0deefc612d4c6066cff652cad0937191b140aa8554f19b334538f1b0a"
		)
	]
)