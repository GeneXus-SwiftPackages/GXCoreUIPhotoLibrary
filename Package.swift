...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-2.1.0-beta.23.xcframework.zip",
			checksum: "6fa1b6c2350a2027fbd923ce58ecee5c5fb90067871365cacf920a75b4e3cd5b"
		)
	]
)