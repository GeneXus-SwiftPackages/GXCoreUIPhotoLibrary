...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.5.0-beta.21.xcframework.zip",
			checksum: "640383e9fde794d4c466e75560c68fc5afa2416e2bcf7da0eaa31bf45bfe07b6"
		)
	]
)