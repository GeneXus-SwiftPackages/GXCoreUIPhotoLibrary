...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.1.0-beta.26.xcframework.zip",
			checksum: "6a3641c4ae3d080e8e03664b0d6c5f6b37ef6c336effddfa65c3c46516edad04"
		)
	]
)