...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreUIPhotoLibrary-1.3.0-rc.13.xcframework.zip",
			checksum: "62960e3303974d0699d284f85e6ff437abeabd3673bfab0b1ca5e4ba6835992d"
		)
	]
)