...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-2.0.0-beta.7.xcframework.zip",
			checksum: "5ee1d0ebf6e46450f12defe421c926636832fce777327e330c9189260c213c48"
		)
	]
)