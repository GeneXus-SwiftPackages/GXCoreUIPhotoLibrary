...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreUIPhotoLibrary-4.2.0-rc.20.xcframework.zip",
			checksum: "b627cb2f8038d2a225b92d2e638a0956689f3f807f411af237717578747e2974"
		)
	]
)