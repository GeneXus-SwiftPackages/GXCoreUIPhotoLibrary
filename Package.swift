...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreUIPhotoLibrary-4.0.0-rc.0.xcframework.zip",
			checksum: "c1fde4e5461b48102a32a0f59b2ef59c69cfa39412ac3b887267682492fc6927"
		)
	]
)