...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreUIPhotoLibrary-4.0.16.xcframework.zip",
			checksum: "f2290133b514a5bc88f6e53b391834a089b8ce4e371bf2c08cfbd1e0020d9aa4"
		)
	]
)