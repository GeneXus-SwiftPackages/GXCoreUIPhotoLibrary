...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreUIPhotoLibrary-2.1.0.xcframework.zip",
			checksum: "d129190900519b8fd3717017ab03b41395f2cce7ccd9ca8b754a12689928dbff"
		)
	]
)