...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-4.2.0-beta.30.xcframework.zip",
			checksum: "49eee141f0d57afc650d3cfbc79b70d8a8324e021a19496def6bab647b16c186"
		)
	]
)