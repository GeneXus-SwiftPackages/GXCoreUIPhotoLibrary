...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-2.0.0-beta.21.xcframework.zip",
			checksum: "379a921d8d6045230d2222c22a1b0f38689d9f421688cdd3f4a0221bea08fd7a"
		)
	]
)