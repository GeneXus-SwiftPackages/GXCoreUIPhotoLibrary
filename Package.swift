...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.2.0-beta.18.xcframework.zip",
			checksum: "88ef82c8dccb3cd2b9b5e39d3eb77916d3b5e972a88834bbf5f8193abe24b206"
		)
	]
)