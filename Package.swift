...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.5.0-beta.3.xcframework.zip",
			checksum: "0e5a42e967386c3fac6abd8080cd0e85bf62bd3d7f551b20daea731289893c5e"
		)
	]
)