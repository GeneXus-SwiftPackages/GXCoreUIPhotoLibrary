...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-5.0.0-beta.5.xcframework.zip",
			checksum: "eb3d2858c685f0ae4f34a7f41a5e4338431f1c487c2bf407c7ce5f6e5b108547"
		)
	]
)