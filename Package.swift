...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.2.0-beta.13.xcframework.zip",
			checksum: "0fd77ed203234017e0769a7ccb91c78e58f1f747ee93e457ba5fb6d20c674d1a"
		)
	]
)