...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.2.0-beta.32.xcframework.zip",
			checksum: "58077d39a0342125dbc54c3b8b81966fc6a0877d16369cc1e52ddb1025b710bc"
		)
	]
)