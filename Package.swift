...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-4.2.0-beta.6.xcframework.zip",
			checksum: "554e5bd3c1adc05921b2420f02b73f2cfa512ff33fa7cef8051481990fcbc382"
		)
	]
)