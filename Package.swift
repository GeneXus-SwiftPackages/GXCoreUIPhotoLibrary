...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.1.0-beta.31.xcframework.zip",
			checksum: "1a934755bace888790d50d23c9a7461b48b2861472ef415c2a4b773a94a05e04"
		)
	]
)