...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-4.1.0-beta.6.xcframework.zip",
			checksum: "92ba0f319b8d3bc108e555bd605c43a12f463fe7324a06e30de9391c249988c4"
		)
	]
)