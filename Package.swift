...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreUIPhotoLibrary-4.0.9.xcframework.zip",
			checksum: "d713c82fc5981c1ed78c479cf884712a07dfd3a9594d8e83f75ae2920c3b4352"
		)
	]
)