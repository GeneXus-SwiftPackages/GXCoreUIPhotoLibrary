...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-4.2.0-beta.20.xcframework.zip",
			checksum: "b31be20bdb522f50cdd91d94cf552c1ef0bb5454eec1994d1978651ed1b5b40a"
		)
	]
)