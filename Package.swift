...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.1.0-beta.7.xcframework.zip",
			checksum: "3c5503d119c4cd4277afb21cede71a6fc35ca9faab4c428ab69f90a90e9710ca"
		)
	]
)