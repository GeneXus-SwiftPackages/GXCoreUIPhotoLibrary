...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-4.2.0-beta.22.xcframework.zip",
			checksum: "f086f1e4761d37f7d146df832abcafafd87d73b42344a7593aeab153932ad467"
		)
	]
)