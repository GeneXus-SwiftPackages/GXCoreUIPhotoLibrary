...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-2.1.0-beta.25.xcframework.zip",
			checksum: "baf96cf1f6385f9ce496ce45bf779447f6dda9a4ee8510de26b92b0567e8cdad"
		)
	]
)