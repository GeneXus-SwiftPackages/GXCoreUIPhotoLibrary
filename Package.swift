...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreUIPhotoLibrary-4.1.0-rc.24.xcframework.zip",
			checksum: "fbb741d20d7b9194fa4cea1c9b621256215bc8afdf2583de2ab77a6c4f05df0f"
		)
	]
)