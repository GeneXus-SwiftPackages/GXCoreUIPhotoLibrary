...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-4.2.0-beta.37.xcframework.zip",
			checksum: "d5e6b3d7eeed180c7c0d046e5083150da9ec2dcd344544da6802ea2e8be0068d"
		)
	]
)