...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-4.2.0-beta.25.xcframework.zip",
			checksum: "71540511891c620c033cc7b9d22da9c38187dc3eae5909f9e80cd8a106150833"
		)
	]
)