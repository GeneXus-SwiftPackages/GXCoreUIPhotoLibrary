...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-2.0.0-beta.40.xcframework.zip",
			checksum: "0011cdeb44f1b28485a6b5882ad451cf290308daaf1e3064ab18f3a02ddbd27b"
		)
	]
)