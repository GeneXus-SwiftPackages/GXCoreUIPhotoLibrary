...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.4.0-beta.4.xcframework.zip",
			checksum: "8037512dca2c8b9d7f3d4bb14897cac17edb68268dedb694397ed5d8f0dac631"
		)
	]
)