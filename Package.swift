...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreUIPhotoLibrary-3.0.4.xcframework.zip",
			checksum: "7da811b8606b4e40df4fe33d1ce9ce66f55de483eefdb976660217c3b38fa326"
		)
	]
)