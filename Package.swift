...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-2.0.0-beta.29.xcframework.zip",
			checksum: "35b5006fb13cebaa896d3182d056876bd7a577f4a3ce69da8699f067c6691b1d"
		)
	]
)