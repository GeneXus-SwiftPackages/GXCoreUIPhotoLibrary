...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-2.2.0-beta.19.xcframework.zip",
			checksum: "6a907c81ef80a967ec448d5875912edfc047b9601180b16f80b4050123bce92c"
		)
	]
)