...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.4.0-beta.17.xcframework.zip",
			checksum: "a2b262acfc93747855be5823ad922c88ad9160666c67b1ffeccb551f19145bc6"
		)
	]
)