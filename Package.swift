...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-5.0.0-beta.4.xcframework.zip",
			checksum: "c089bbd079a3cc5558e692498a06b6fb4df94341c559a152552392a83a8b41a0"
		)
	]
)