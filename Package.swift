...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreUIPhotoLibrary-4.0.17.xcframework.zip",
			checksum: "897e96ad8df2e0cb8dad9217e56b0a568a8f7d34a25a8012142d4b5ad16ef068"
		)
	]
)