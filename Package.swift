...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.5.0-beta.2.xcframework.zip",
			checksum: "deaceb0014219a67f5fc714bb7626bf720e6aa093f087293e90ee4c34ac35ab7"
		)
	]
)