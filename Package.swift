...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.6.0-beta.1.xcframework.zip",
			checksum: "9b2aaa658c380622bbd4fb6118ced2fa393a211a70aef3c1ab2d7f8b64e6b0ab"
		)
	]
)