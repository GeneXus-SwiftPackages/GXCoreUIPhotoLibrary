...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-2.0.0-beta.39.xcframework.zip",
			checksum: "4393d85825ff1187f29686e80e2d3ff2f461725ecaf26c1b5848e28e32981d9e"
		)
	]
)