...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.2.0-beta.36.xcframework.zip",
			checksum: "d1c37d7606147da4f64b888e0f516d430848e168f6e32ab69df7bce8459a5702"
		)
	]
)