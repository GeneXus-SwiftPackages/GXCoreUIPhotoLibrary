...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.2.0-beta.16.xcframework.zip",
			checksum: "a060ff0989cc4500d8f56455c1f82167964bfdebbed7dd16e8fc10437af10a5f"
		)
	]
)