...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-2.0.0-beta.25.xcframework.zip",
			checksum: "31fe53ba7088af49ace3c5d23580f88cc06b5b76d2ca85bbe11508c319abb05e"
		)
	]
)