...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-2.1.0-beta.24.xcframework.zip",
			checksum: "9f84859784aa6facf08bce09263fd94f7109b452be24bd0a78dbd69cf0c1bc10"
		)
	]
)