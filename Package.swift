...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreUIPhotoLibrary-4.0.8.xcframework.zip",
			checksum: "cf08b594e82810e3173300ffd70dfcafeaa1726f323ebfcf27fd79c8fcd4e842"
		)
	]
)