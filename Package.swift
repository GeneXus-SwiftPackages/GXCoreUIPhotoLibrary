...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.1.0-beta.25.xcframework.zip",
			checksum: "cd2c0b0baeb7c3374446dcecf00a91ce9f8578b9d57552a0a700bf3267317ccd"
		)
	]
)