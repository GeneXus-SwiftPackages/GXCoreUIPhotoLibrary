...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.0.0-beta.13.xcframework.zip",
			checksum: "719aa41aa3ac1c186575049fad579e87f779a0364ea4a7f895637b54d36bab16"
		)
	]
)