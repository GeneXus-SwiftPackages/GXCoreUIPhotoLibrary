...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreUIPhotoLibrary-2.0.0-rc.32.xcframework.zip",
			checksum: "1eac16bc3de3a310f76a3aab834e0ddb512a7bd486ebdf5f1ecaf118fc061b30"
		)
	]
)