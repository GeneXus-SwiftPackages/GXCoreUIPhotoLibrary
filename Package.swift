...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreUIPhotoLibrary-3.2.0-rc.9.xcframework.zip",
			checksum: "c80191ed44ab8de097fb1fbee8c9c1ccde15d7fe55a94a40f905d195203866cc"
		)
	]
)