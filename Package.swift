...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.4.0-beta.14.xcframework.zip",
			checksum: "a2d14d82aab88421f75810d082cf2d1c04c8c0a72e3d51eac417c9dcd23f3153"
		)
	]
)