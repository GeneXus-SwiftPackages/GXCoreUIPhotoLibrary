...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.5.0-beta.26.xcframework.zip",
			checksum: "d126998a435f26801ffff8a06ea3ca498e2d15ac0a5d0bc3db434d7c021281d0"
		)
	]
)