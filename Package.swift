...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.2.0-beta.37.xcframework.zip",
			checksum: "1bfd635df26d257129c0b32558f1b11fe6da61101515bdd0b468c323dd8ba655"
		)
	]
)