...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.1.0-beta.16.xcframework.zip",
			checksum: "7db9a4ba9f51d1f8fce3654f46e98d598db6e4e083e82d97bb4decb51264eefa"
		)
	]
)