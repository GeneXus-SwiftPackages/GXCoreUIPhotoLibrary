...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.2.0-beta.19.xcframework.zip",
			checksum: "2d4815cd86390a6883d308f8ad24637dd0a556408839bd6577afa83e7d238d9e"
		)
	]
)