...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-5.0.0-beta.1.xcframework.zip",
			checksum: "eea9eac12687e96ce144af66ff99dd51f5d567e913f07c83bc9ad0e8090730de"
		)
	]
)