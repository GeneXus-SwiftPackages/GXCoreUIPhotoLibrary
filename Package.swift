...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreUIPhotoLibrary-4.0.0-rc.43.xcframework.zip",
			checksum: "e795b1b48e091cba732f99bc221585f653b6e3c8a62f9b04cfd75a3abaf976d2"
		)
	]
)