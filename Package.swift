...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-4.2.0-beta.29.xcframework.zip",
			checksum: "e551adcfc57e5ab9403d0c8f201911683ad6cccc2a80f17bda5c2fe51f026161"
		)
	]
)