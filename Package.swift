...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.0.0-beta.16.xcframework.zip",
			checksum: "2814cdd8c069f1f14d3c3f0419a28537a58c68ae210062753591265c7ed26bf3"
		)
	]
)