...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.5.0-beta.15.xcframework.zip",
			checksum: "0cb63bf85eeef854d25e9689e05365f43d3a7301fc503f5d87d8ea078493e91f"
		)
	]
)