...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-4.2.0-beta.27.xcframework.zip",
			checksum: "3f975513802c80c12ebeea8d8d5ed8c65a716769b16d528becc860a505660488"
		)
	]
)