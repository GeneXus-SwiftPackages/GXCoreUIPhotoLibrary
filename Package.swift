...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreUIPhotoLibrary-4.2.0-rc.3.xcframework.zip",
			checksum: "3c1346b9f1edb429ceeb90542b324277e8844db303cbc866dcc958b69e5f07af"
		)
	]
)