...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreUIPhotoLibrary-4.0.6.xcframework.zip",
			checksum: "2bee7ddfc26183762731a5df34e02e287c56c1dda1f53bb4b5ffe1fd0e670994"
		)
	]
)