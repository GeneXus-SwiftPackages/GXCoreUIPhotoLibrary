...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreUIPhotoLibrary-1.5.11.xcframework.zip",
			checksum: "f290d64420edf88273b84820d3a9c28a732a141b7239fb3458a8746c7812699d"
		)
	]
)