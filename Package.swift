...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreUIPhotoLibrary-1.5.0-rc.28.xcframework.zip",
			checksum: "50857f669a1146620420ec98249e3b26b513ae4353bb447b0ed2054bb785aba1"
		)
	]
)