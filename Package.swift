...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreUIPhotoLibrary-4.1.0-rc.3.xcframework.zip",
			checksum: "9989cbcd57ef5207150ddf9003d1564ea1e8d9dc8af355acd6195be227f7110f"
		)
	]
)