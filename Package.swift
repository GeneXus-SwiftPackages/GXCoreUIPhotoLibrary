...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreUIPhotoLibrary-4.0.2.xcframework.zip",
			checksum: "ad4828db9189fc68b4f84a9ac901aeb0001ed00a68f6949e6c44fe063da27d62"
		)
	]
)