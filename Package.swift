...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-2.2.0-beta.20.xcframework.zip",
			checksum: "b36d88a5181fe54d34157dcfac036624f9b01ca262a3865fe6b4bcc1e4d8b2ff"
		)
	]
)