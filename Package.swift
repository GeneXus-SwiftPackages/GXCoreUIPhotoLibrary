...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-4.2.0-beta.11.xcframework.zip",
			checksum: "19accd949a34d7b639e9cf8a23555e7d274441bbe78f47138ed9a1a4aed38c1e"
		)
	]
)