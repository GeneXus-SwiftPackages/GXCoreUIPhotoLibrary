...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.2.0-beta.36.xcframework.zip",
			checksum: "cb4a130a06d3a56d41748f8cd2cb897a85562a60671a929fe130c8416fd93a02"
		)
	]
)