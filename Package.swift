...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.2.0-beta.27.xcframework.zip",
			checksum: "8d8fbec820162eaecf9c905cf63666f04dc81164f421fdd18ddf434b7551330c"
		)
	]
)