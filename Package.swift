...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreUIPhotoLibrary-1.4.30.xcframework.zip",
			checksum: "aaa8fd77f78cfd749ed29053c3a9bb65eb39ba7db578731c41d0c055da07edc5"
		)
	]
)