...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreUIPhotoLibrary-1.4.0-rc.10.xcframework.zip",
			checksum: "1770fc41d8a2c67450d9bb232417f213eb378e5de1f26edc144081e0263600d0"
		)
	]
)