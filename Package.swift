...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.5.0-beta.6.xcframework.zip",
			checksum: "e33a8b12fea443887cde1cb43828070ffac0255e3d9ad655892ec21d3a622ab1"
		)
	]
)