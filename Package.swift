...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.1.0-beta.9.xcframework.zip",
			checksum: "0f0d65e1fc38858d713fd3e30e5e01c737105f0f85be4059375a7cbe2f88580f"
		)
	]
)