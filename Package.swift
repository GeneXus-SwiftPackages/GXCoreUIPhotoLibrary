...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-2.0.0-beta.38.xcframework.zip",
			checksum: "9a47ace73fe14acf63f4e84e8ec5c73e02937d81200ea45bb1aa7b0cf35590ba"
		)
	]
)