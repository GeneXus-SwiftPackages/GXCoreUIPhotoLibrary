...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreUIPhotoLibrary-1.3.0-rc.1.xcframework.zip",
			checksum: "672fee9746cab66b7ec22d52402fce8cc074a930a20bc4c1b56ac746e2f9f12e"
		)
	]
)