...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.1.0-beta.1.xcframework.zip",
			checksum: "6092e9bf0d26d0091b711b1a7dd446ca49750f3a26f99513fc830382a3735545"
		)
	]
)