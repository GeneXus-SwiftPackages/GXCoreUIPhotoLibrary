...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.2.0-beta.7.xcframework.zip",
			checksum: "ff8aa32c72afcb3a538342d72ad412fb9f4521555966410ec24d3abf70c61d6a"
		)
	]
)