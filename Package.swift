...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-2.2.0-beta.12.xcframework.zip",
			checksum: "259da1ce393cab82e248b8a49a957b8bdcf9b4ef7dac952b31b59a25325c5e07"
		)
	]
)