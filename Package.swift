...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.3.0-beta.6.xcframework.zip",
			checksum: "fbae7ee794bddd5bce84058d627fe7f9ac0dea900b9f59985ae90ffee1cb455a"
		)
	]
)