...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.2.0-beta.24.xcframework.zip",
			checksum: "6cf12c2c97a7ae400e5371a3527b1fe19cb276de801fec6ddd98763ea467a54d"
		)
	]
)