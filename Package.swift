...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.2.0-beta.34.xcframework.zip",
			checksum: "4f0b14be105409fccc3970a54b950624d1cdbca2cda026b7a68ec7bf7d468638"
		)
	]
)