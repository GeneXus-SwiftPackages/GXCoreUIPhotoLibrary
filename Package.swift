...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreUIPhotoLibrary-1.5.0-rc.26.xcframework.zip",
			checksum: "a10678dbfa10582992a42633a4771faba4069d4728023c919dd06b21bf8763e5"
		)
	]
)