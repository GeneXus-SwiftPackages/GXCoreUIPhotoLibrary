...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.3.0-beta.7.xcframework.zip",
			checksum: "c4116f91b3c08b571fc45f8ff049724eb54cee0d53aab7f740c7c954e493e3d2"
		)
	]
)