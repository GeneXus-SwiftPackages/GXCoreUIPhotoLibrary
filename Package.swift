...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreUIPhotoLibrary-3.0.0.xcframework.zip",
			checksum: "cf730eb4d7b49428104189b3d9837c770f0c85bbeb84bba8a18a0f1734f2fdcd"
		)
	]
)