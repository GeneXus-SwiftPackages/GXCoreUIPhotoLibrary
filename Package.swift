...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreUIPhotoLibrary-1.3.0-rc.7.xcframework.zip",
			checksum: "1ec206a36723188ef30667b7f87d8c951ecd2408c5057a45ee0878b3fd3c5467"
		)
	]
)