...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.2.0-beta.31.xcframework.zip",
			checksum: "206b0dd0a5a0c0eea4ae6895939297bccb6eb26b6849fb802e16e902810f64d4"
		)
	]
)