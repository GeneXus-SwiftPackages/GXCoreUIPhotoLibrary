...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-4.0.0-beta.49.xcframework.zip",
			checksum: "c67e3528ff2624be5b4350eba23fa60b34bf1db2f4aba01d5a5edf34a55adf2a"
		)
	]
)