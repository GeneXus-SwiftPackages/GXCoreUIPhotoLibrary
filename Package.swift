...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreUIPhotoLibrary-3.1.1.xcframework.zip",
			checksum: "410cd4873887062dfc396b07589bc1621d542edcf3268a2a16189a60a55491d7"
		)
	]
)