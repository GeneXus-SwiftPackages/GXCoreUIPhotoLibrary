...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.1.0-beta.10.xcframework.zip",
			checksum: "589d0c94a5f7717d68ebdf8a08ac9366ce3329dc23259621af5246d3f5e42648"
		)
	]
)