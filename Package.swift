...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreUIPhotoLibrary-4.2.0-rc.37.xcframework.zip",
			checksum: "eeca4df5939c94142702a4bf3851deeefcfdb20ca6e53c55449865674cbaacb8"
		)
	]
)