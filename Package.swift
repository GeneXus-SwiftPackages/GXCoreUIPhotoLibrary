...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.0.0-beta.9.xcframework.zip",
			checksum: "edb94fe1b4d60621252d3a92f633ed8b49ae107a54941c504c20cf65d025343a"
		)
	]
)