...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-2.0.0-beta.37.xcframework.zip",
			checksum: "d7def0b74d08148be49a812c5abb0cb9fd0475cd00aff3f88780baa68312b425"
		)
	]
)