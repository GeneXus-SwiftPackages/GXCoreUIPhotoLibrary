...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.5.0-beta.20.xcframework.zip",
			checksum: "aea1f115e2e1d91e71c20b4ede0292e5a724b6694f56854bd7164caa20572022"
		)
	]
)