...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.2.0-beta.20.xcframework.zip",
			checksum: "c70dcec657a36f14cdabab8dc8d2c2ad4ac33b3c4ab322edc7d306e2456819b3"
		)
	]
)