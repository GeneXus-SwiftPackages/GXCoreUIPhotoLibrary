...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-4.2.0-beta.26.xcframework.zip",
			checksum: "d109760aa544972e127f638896e81f8c9a1beadb196fad477a476d7a9cb7690e"
		)
	]
)