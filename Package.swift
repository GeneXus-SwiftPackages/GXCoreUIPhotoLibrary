...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreUIPhotoLibrary-2.0.0-rc.22.xcframework.zip",
			checksum: "55a00076c6f8ac04d819ae14309ed338050858a9df15a826b02d51ce35621a30"
		)
	]
)