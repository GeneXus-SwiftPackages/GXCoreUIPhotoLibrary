...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.0.0-beta.11.xcframework.zip",
			checksum: "e85cd06925b3a51478ccc0cc127c57fb7ddebfd6553d8df927b806ad279923d7"
		)
	]
)