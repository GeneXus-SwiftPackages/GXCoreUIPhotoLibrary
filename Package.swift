...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-4.2.0-beta.15.xcframework.zip",
			checksum: "f1205221a941fae55c8d4b40a80eb99c3eb803c23f00b0eb7adc72979749da43"
		)
	]
)