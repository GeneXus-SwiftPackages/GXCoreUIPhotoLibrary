...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreUIPhotoLibrary-2.0.18.xcframework.zip",
			checksum: "6baff85e3479712d9c347d0b6789011f112084e974ad141d023d06ad0423c646"
		)
	]
)