...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-4.2.0-beta.39.xcframework.zip",
			checksum: "80b0da777d92c7617bfbdce3450be54cc0fae1a53943c3fe4bbca3b078a4586a"
		)
	]
)