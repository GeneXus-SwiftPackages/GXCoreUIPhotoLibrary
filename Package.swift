...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-1.2.0-beta.28.xcframework.zip",
			checksum: "7dbd81f29b3e35e253c320bd5d98adb2da235d8aa5e1addf39f7573e1ebf2c94"
		)
	]
)