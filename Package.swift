...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreUIPhotoLibrary-4.0.7.xcframework.zip",
			checksum: "52c183fb5ba4d3dc6838df6e18c5fe390eabdca69e449236e254e58f02751757"
		)
	]
)