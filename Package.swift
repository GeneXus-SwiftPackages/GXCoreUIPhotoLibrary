...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUIPhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUIPhotoLibrary-3.2.0-beta.25.xcframework.zip",
			checksum: "bb70fd2080c09b34ba02aa090ef5733caeac32647b1c5439a790e344933afed6"
		)
	]
)